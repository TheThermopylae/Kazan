      ...
      >
        <g fill="none" stroke="currentColor" stroke-width="1.5">
          <path
            ...
            d="M12.95 22c2.645 0 3.967 0 4.917-.756c.95-.757 1.252-2.051 1.858-4.64l1.917-8.197c.335-1.433.503-2.15.198-2.67C21.289 4.796 19.88 5 18.96 5"
          />
          <path
          ...
          />
          <path
            d="M10.5 6a4 4 0 0 1 0 8m0-8a4 4 0 1 0 0 8m0-8C9.672 6 9 7.79 9 10s.672 4 1.5 4m0-8c.828 0 1.5 1.79 1.5 4s-.672 4-1.5 4"
          />
          <path stroke-linecap="round" d="M7 17h7" />
        </g>
      </svg>
      شناسنامه | پاسپورت
    </button>
