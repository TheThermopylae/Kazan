<template>
  <header
    ...
    <div class="flex items-center gap-5">
      <button to="/" class="bg-primary rounded-full px-3 py-2 text-white hidden lg:flex items-center gap-2 cursor-pointer" @click="showFormFunc">
        ورود یا ثبت نام
    ...
    <div class="lg:hidden">
      <button to="/" class="bg-primary rounded-full px-3 py-2 text-white flex items-center gap-2" @click="showFormFunc">
        ورود یا ثبت نام
        <svg width="13" height="7" viewBox="0 0 13 7" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.5 0.916626L6.38215 5.86713C6.44724 5.93313 6.55276 5.93313 6.61785 5.86713L11.5 0.916626"
            stroke="white" stroke-width="1.5" stroke-linecap="round" />
