<template>
    <div class="hidden lg:flex items-center gap-3">
        <button to="/"
            ...
            @click="showFormFunc" v-if="!userLogged">
            ورود یا ثبت نام
        ...
        <div v-else class="flex gap-3">
            <Button unstyled type="button" @click="toggleWallet" aria-haspopup="true"
                pt:root="!size-10 !bg-maindark !rounded-full !flex !justify-center !items-center !cursor-pointer"
            ...
            <Button unstyled type="button" @click="toggleNotif" aria-haspopup="true"
                pt:root="!size-10 !bg-maindark !rounded-full !flex !justify-center !items-center !cursor-pointer"
                aria-controls="overlay_menu">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <div class="hidden lg:block">
            <button class="flex-center bg-white size-10 rounded-full cursor-pointer dark:!hidden" @click="switchDark">
            ...
            <button class="!hidden flex-center bg-maindark text-white size-10 rounded-full cursor-pointer dark:!flex"
                @click="switchLight">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
        ...
        <Menu ref="walletMenu" id="overlay_menu" :model="walletItems" :popup="true"
            pt:root="!w-[220px] !border-none !rounded-10 !p-1" pt:list="!max-h-[500px] !overflow-auto"
            pt:submenuLabel="!hidden" pt:separator="!my-1">
        </Menu>
        <Menu ref="notifMenu" id="overlay_menu" :model="notifItems" :popup="true"
            pt:root="w-[400px] !border-none !rounded-10 !p-1" pt:list="!max-h-[500px] !overflow-auto"
            pt:submenuLabel="!hidden">
            <template #start>
                <div class="flex justify-between p-3">
                    پیام‌ها
                    <NuxtLink to="/" class="text-primary ">نمایش همه</NuxtLink>
                </div>
            </template>
            <template #item v-for="item in notifItems">
                <div class="p-2">
                    <h4 class="text-xl font-bold mb-1">{{ item[0] }}</h4>
                    <p>{{ item[1] }}</p>
                </div>
            </template>
        </Menu>
...
const notifItems = ref([
    ['title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem omnis vero quaerat ipsam, ratione velit quam animi asperiores est! Corporis?'],
    ['title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem omnis vero quaerat ipsam, ratione velit quam animi asperiores est! Corporis?'],
    ['title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem omnis vero quaerat ipsam, ratione velit quam animi asperiores est! Corporis?'],
    ['title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem omnis vero quaerat ipsam, ratione velit quam animi asperiores est! Corporis?'],
    ['title', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem omnis vero quaerat ipsam, ratione velit quam animi asperiores est! Corporis?'],
