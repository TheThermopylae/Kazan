  ...
  <section class="mb-3 bg-white dark:bg-maindark rounded p-4">
    ...
    <div class="flex-grow overflow-auto">
      <table class="min-w-[800px] w-full">
        ...
        <tbody>
          <tr
            class="group relative border-b last:border-none border-gray-200 dark:border-darkstroke text-sm text-[#5F5F5F]"
            v-for="item in 3"
          >
            ...
            <td class="py-5 dark:text-textdark">
              <button
                class="transition hover:bg-failbg dark:hover:bg-failbg/10 text-fail py-2 px-2.5 rounded"
              >
                حذف
              </button>
            </td>
