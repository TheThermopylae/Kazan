<template>
  <footer class="bg-[#F2F8FF] dark:bg-[#1F1F1F] pt-5 pb-2">
    <div class="grid grid-cols-4 container gap-10">
      <div>
        <h4 class="text-xl font-bold">درباره ما</h4>
        <p class="mt-5">
      ...
      <div class="place-items-center">
        <h4 class="text-xl font-bold mb-5">راهنمای استفاده</h4>
        <ul>
          <li class="mb-3">نحوه ثبت نام</li>
          <li class="mb-3">نحوه واریز</li>
          <li class="mb-3">نحوه معامله</li>
          <li class="mb-3">سوالات متداول</li>
          <li>تغییر شماره موبایل</li>
        </ul>
      </div>
      <div>
        <h4 class="text-xl font-bold mb-5">خدمات مشتریان</h4>
        <ul>
          <li class="mb-3">دعوت از دوستان</li>
          <li class="mb-3">دانلود اپلیکیشن</li>
          <li class="mb-3">نحوه معامله</li>
          <li class="mb-3">تحلیل ارز‌دیجیتال</li>
          <li class="mb-3">ماشین‌ حساب ارز‌دیجیتال</li>
          <li>ثبت‌نام حقوقی</li>
        </ul>
      </div>
      <div class="flex flex-col items-center gap-2">
        ...
        <p>اولین صرافی ایرانی در روسیه</p>
