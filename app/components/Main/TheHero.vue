    ...
    <div class="container flex justify-between items-center gap-10">
      <div class="flex flex-col justify-between h-full gap-6">
        ...
        <p class="leading-8 text-sm">
          ...
          کازان با ارائه خدمات آنلاین به شما امکان می‌دهد تا با کمترین کارمزد و
          به صورت فوری روبل خود را به ریال یا بلعکس تبدیل کنید. ما روزانه
      ...
      <NuxtImg src="/main/hero.svg" class="w-11/12"></NuxtImg>
    </div>
  </section>
</template>
